...
use cda_interfaces::{
    DiagServiceError, EcuAddresses, EcuCanGateway, EcuGateway, HashMap, ReusableTransportResource,
    ServicePayload, Shutdown, TransmissionParameters, TransportResponse,
};
...
impl<D: EcuGateway + ReusableTransportResource, C: EcuCanGateway> ReusableTransportResource
...
#[async_trait]
impl<D: EcuGateway + Shutdown, C: EcuCanGateway + Shutdown> Shutdown
    for DiagnosticTransportRouter<D, C>
{
