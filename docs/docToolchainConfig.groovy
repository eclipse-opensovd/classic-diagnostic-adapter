...
// find "." -not -path "./build/**" -type f \( -iname "*.adoc" -o -iname "*.puml" \) -printf '%P\n' | xargs -I '{}' echo "[file: '{}', formats: ['html', 'pdf']],"
inputFiles = [
        [file: 'index.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/index.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/01_overview.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/02_terminology.adoc', formats: ['html', 'pdf']],

        [file: 'architecture/03_sovd-api/index.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/01_introduction.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/02_sovd-api.adoc', formats: ['html', 'pdf']],

        [file: 'architecture/03_sovd-api/03_extensions/index.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/03_extensions/01_flash-api.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/03_extensions/01_flashing_sequence.puml', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/03_extensions/02_functional-comm-api.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/03_extensions/03_com-params.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/03_extensions/04_mdd-embedded-file-api.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/03_sovd-api/03_extensions/05_single-ecu-jobs.adoc', formats: ['html', 'pdf']],

        [file: 'architecture/04_communication/index.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/04_communication/01_doip_communication.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/04_communication/02_uds_communication.adoc', formats: ['html', 'pdf']],

        [file: 'requirements/index.adoc', formats: ['html', 'pdf']],
        [file: 'requirements/01_introduction.adoc', formats: ['html', 'pdf']],
        [file: 'requirements/02_terminology.adoc', formats: ['html', 'pdf']],
        [file: 'requirements/03_general.adoc', formats: ['html', 'pdf']],
        [file: 'requirements/04_sovd.adoc', formats: ['html', 'pdf']],
        [file: 'requirements/05_uds.adoc', formats: ['html', 'pdf']],
        [file: 'requirements/06_doip.adoc', formats: ['html', 'pdf']],
...
customTasks = [
//'scripts/createAndCopyOpenApi.gradle',
		/** customTasks **/
]
...
microsite.with {
    ...
    title = 'Eclipse OpenSOVD Classic Diagnostic Adapter'
    // the next items configure some links in the footer
    //
    // contact eMail
    // example: mailto:bert@example.com
    footerMail = 'mailto:opensovd-dev@eclipse.org'
    //
    // twitter account url
    footerTwitter = ''
    //
    ...
    //
    // Github Repository
    footerGithub = 'https://github.com/eclipse-opensovd/classic-diagnostic-adapter'
    //
    // Slack Channel
    footerSlack = 'https://sdvworkinggroup.slack.com/archives/C0958MQNGP2'
    //
    // Footer Text
    ...
    issueUrl = 'https://github.com/eclipse-opensovd/classic-diagnostic-adapter/issues/new'
    //
    ...
    gitRepoUrl = 'https://github.com/eclipse-opensovd/classic-diagnostic-adapter'
...
openApi.with {
    specFile = 'architecture/03_sovd-api/test_again.yaml'
    infoUrl = 'https://github.com/eclipse-opensovd/classic-diagnostic-adapter'
    infoEmail = 'opensovd-dev@eclipse.org'
}
//end::openApiConfig[]
