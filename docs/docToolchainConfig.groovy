...
inputFiles = [
        ...
        [file: 'architecture/flashing.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/doip_communication.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/uds_communication.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/sovd-api/index.adoc', formats: ['html', 'pdf']],
        [file: 'architecture/sovd-api/flash-api.adoc', formats: ['html', 'pdf']],
