...
async fn test_communication_control() {
    ...
    .unwrap()
    .unwrap();
    assert!(matches!(result.value.as_ref(), "EnableRxAndEnableTx"));
    ...
    .unwrap()
    .unwrap();
    assert!(matches!(result.value.as_ref(), "EnableRxAndDisableTx"));
    ...
    .unwrap()
    .unwrap();
    assert!(matches!(result.value.as_ref(), "DisableRxAndEnableTx"));
    ...
    .unwrap()
    .unwrap();
    assert!(matches!(result.value.as_ref(), "DisableRxAndDisableTx"));
    ...
    .unwrap()
    .unwrap();
    assert!(matches!(result.value.as_ref(), "TemporalSync"));
