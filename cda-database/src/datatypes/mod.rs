...
/// Used for matching services against UDS payload prefixes.
...
impl DiagService<'_> {
    ...
    /// ```
    ///  use cda_database::datatypes::CodedConstParam;
    /// vec![
    ///     CodedConstParam { byte_position: 0, value: 0x31, bit_length: 8 },
    ///     CodedConstParam { byte_position: 1, value: 0x01, bit_length: 8 },
    ///     CodedConstParam { byte_position: 2, value: 0x0246, bit_length: 16 },
    /// ];
    /// ```
    pub fn extract_sequential_coded_consts(&self) -> Vec<CodedConstParam> {
