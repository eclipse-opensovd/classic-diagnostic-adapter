...
pub mod get {
    pub type Response = crate::components::common::modes::get::Response;
    pub type ResponseItem = crate::components::common::modes::get::ModeCollectionItem;
}
...
pub mod security_and_session {
    pub mod get {
        ...
        pub type Response = crate::components::common::modes::get::Mode<String>;
    }
    pub mod put {
        ...
        pub type Response<T> = crate::components::common::modes::put::Response<T>;
    }
}
...
pub mod commctrl {
    pub mod put {
        ...
        pub type Request = crate::components::common::modes::commctrl::put::Request;
        pub type Response = crate::components::common::modes::put::Response<String>;
    }
}
