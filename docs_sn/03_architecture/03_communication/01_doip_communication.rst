...
.. note::
   When these parameters are set via mdd, multiple mdd-files could match due to duplicated logical addresses. TODO: specify how to resolve this behavior (e.g. use most lax settings?)
