...
The API to retrieve embedded files utilizes a bulk-data endpoint, as defined in ../../02_sovd-api/02_sovd-api.rst#architecture_sovd_bulk_data (Architecture: SOVD Bulk Data)
