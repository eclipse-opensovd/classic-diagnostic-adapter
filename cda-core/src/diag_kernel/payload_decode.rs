...
use cda_interfaces::{
    DiagComm, DiagServiceError, HashMap, ServicePayload,
...
use super::ecumanager::{EcuManager, ParamContext};
...
impl<S: SecurityPlugin> EcuManager<S> {
    ...
    pub(crate) async fn convert_from_uds(
        &self,
    ...
    pub(crate) fn convert_service_14_response(
        &self,
        diag_comm: DiagComm,
    ...
    pub(crate) async fn convert_request_from_uds(
        &self,
        diag_service: &cda_interfaces::DiagComm,
        payload: &ServicePayload,
        map_to_json: bool,
    ...
    pub(crate) fn map_param_from_uds(
        &self,
    ...
    pub(crate) fn map_param_reserved_from_uds(
        param_name: &str,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
        param_ctx: ParamContext<'_>,
    ...
    pub(crate) fn map_param_value_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_param_length_key_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_param_matching_request_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        param_name: &str,
        uds_payload: &mut Payload,
    ...
    pub(crate) fn map_param_coded_const_from_uds(
        param_name: &str,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
        param_ctx: ParamContext<'_>,
    ...
    pub(crate) fn map_param_phys_const_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        param_name: &str,
        uds_payload: &mut Payload,
    ...
    pub(crate) fn map_struct_from_uds(
        &self,
    ...
    pub(crate) fn map_nested_struct_from_uds(
        &self,
        structure: &datatypes::StructureDop,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
    ...
    pub(crate) fn map_param_length_info_dop_from_uds(
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
        short_name: String,
    ...
    pub(crate) fn map_dynamic_length_field_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn decode_dynamic_length_field_item(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_mux_dop_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_static_field_dop_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn discriminator_value_from_outer_data(
    ...
    pub(crate) fn map_env_data_desc_item_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        outer_data: &MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_structure_dop_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_end_of_pdu_dop_from_uds(
        &self,
        mapped_service: &datatypes::DiagService,
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
    ...
    pub(crate) fn map_normal_dop_from_uds(
        uds_payload: &mut Payload,
        data: &mut MappedDiagServiceResponsePayload,
        short_name: String,
        normal_dop: &datatypes::NormalDop,
...
pub(crate) fn extract_struct_dop_from_field(
...
pub(crate) fn param_position_order(
    a: &datatypes::Parameter,
    b: &datatypes::Parameter,
) -> std::cmp::Ordering {
...
pub(crate) fn create_diag_service_response(
    diag_service: &cda_interfaces::DiagComm,
...
pub(crate) fn str_to_json_value(
    value: &str,
...
#[cfg(test)]
mod tests {
    use cda_interfaces::{EcuManager, diagservices::DiagServiceResponseType};
    ...
    use crate::diag_kernel::test_utils::ecu_manager_builder::{
        ...
        create_ecu_manager_with_mux_service, create_ecu_manager_with_mux_service_and_default_case,
    ...
    async fn test_map_struct_from_uds_end_pdu_no_maximum() {
        ...
        assert_uds_converts_to_json(
            &ecu_manager,
            &service,
            vec![sid, 0x42, 0x12, 0x34, 0x99, 0x56, 0x78, 0xAA, 0x9A, 0xBC, 0xD0, 0x0F],
            json!({
                "end_pdu_param": [
                    { "item_param1": 0x42, "item_param2": 0x1234 },
                    { "item_param1": 0x99, "item_param2": 0x5678 },
