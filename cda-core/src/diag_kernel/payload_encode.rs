...
use cda_interfaces::{
    DiagServiceError, DynamicPlugin, HashMap, ServicePayload,
...
use crate::diag_kernel::operations::json_value_to_uds_data;
...
impl<S: SecurityPlugin> EcuManager<S> {
    ...
    pub(crate) async fn create_uds_payload(
        &self,
    ...
    pub(crate) async fn check_genericservice(
        &self,
        security_plugin: &DynamicPlugin,
        rawdata: Vec<u8>,
    ) -> Result<ServicePayload, DiagServiceError> {
    ...
    pub(crate) fn map_param_value_to_uds(
        &self,
        param: &datatypes::Parameter,
        value: Option<&serde_json::Value>,
        payload: &mut Vec<u8>,
    ...
    pub(crate) fn map_param_length_key_to_uds(
        param: &datatypes::Parameter,
        value: Option<&serde_json::Value>,
        payload: &mut Vec<u8>,
        parent_byte_pos: usize,
    ...
    pub(crate) fn map_reserved_param_to_uds(
        param: &datatypes::Parameter,
        payload: &mut Vec<u8>,
    ) -> Result<(), DiagServiceError> {
        let reserved_param =
    ...
    pub(crate) fn map_phys_const_param_to_uds(
        &self,
        param: &datatypes::Parameter,
    ...
    pub(crate) fn map_mux_to_uds(
        &self,
        mux_dop: &datatypes::MuxDop,
        value: &serde_json::Value,
        uds_payload: &mut Vec<u8>,
    ) -> Result<(), DiagServiceError> {
        use crate::diag_kernel::operations;
        use crate::diag_kernel::payload_decode::mux_case_struct_from_selector_value;
    ...
    pub(crate) fn map_struct_to_uds(
        &self,
    ...
    pub(crate) fn process_parameter_map(
        &self,
...
pub(crate) fn process_coded_constants(
    mapped_params: &[datatypes::Parameter],
) -> Result<Vec<u8>, DiagServiceError> {
    use crate::diag_kernel::payload_decode::str_to_json_value;
...
mod tests {
    ...
    async fn test_mux_from_and_to_uds_case_3() {
        use cda_database::datatypes::{
            DataType,
            database_builder::EcuDataBuilder,
        };
