...
use cda_interfaces::{
    DiagServiceError, DynamicPlugin, HashMap,
    datatypes::{
...
impl<S: SecurityPlugin> EcuManager<S> {
    pub(crate) fn get_components_data_info(
        &self,
    ...
    pub(crate) fn get_functional_group_data_info(
        &self,
        security_plugin: &DynamicPlugin,
    ...
    pub(crate) fn get_functional_group_operations_info(
        &self,
        security_plugin: &DynamicPlugin,
        functional_group_name: &str,
    ...
    pub(crate) fn get_functional_group_routine_subfunctions(
        &self,
        security_plugin: &DynamicPlugin,
        functional_group_name: &str,
        service_name: &str,
    ...
    pub(crate) fn get_components_single_ecu_jobs_info(&self) -> Vec<ComponentDataInfo> {
    ...
    pub(crate) fn get_components_configurations_info(
        &self,
        security_plugin: &DynamicPlugin,
    ...
    /// with flags indicating whether Stop (0x02) and `RequestResults` (0x03)
    /// subfunctions are also defined.
    pub(crate) fn get_components_operations_info(
        &self,
        security_plugin: &DynamicPlugin,
    ...
    pub(crate) fn get_routine_subfunctions(
        &self,
        service_name: &str,
        security_plugin: &DynamicPlugin,
    ) -> Result<RoutineSubfunctions, DiagServiceError> {
    ...
    pub(crate) fn get_request_parameter_metadata(
        &self,
        service_name: &str,
    ...
    /// short name
    pub(crate) fn get_response_parameter_metadata(
        &self,
        service_name: &str,
    ...
    pub(crate) fn get_mux_cases_for_service(
        &self,
        service_name: &str,
    ...
    pub(crate) fn functional_groups(&self) -> Vec<String> {
    ...
    pub(crate) fn diag_comm_to_component_data_info(
        &self,
    ...
    pub(crate) fn trim_routine_name(&self, name: &str) -> String {
    ...
    pub(crate) fn subfunction_flags_from_services(
    ...
    pub(crate) fn filter_and_transform_operations(
        &self,
    ...
    pub(crate) fn get_meta_data_service(
        &self,
        service_name: &str,
...
mod tests {
    ...
    use cda_interfaces::{DiagComm, DiagCommType, EcuManager, Protocol};
