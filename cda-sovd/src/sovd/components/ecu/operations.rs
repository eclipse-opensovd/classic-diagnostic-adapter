...
pub(crate) mod comparams {
    ...
    pub(crate) mod executions {
        ...
        use crate::sovd::{
            EcuContext, IntoSovd, WebserverEcuState, acquire_communication_activity, create_schema,
            error::{ApiError, ErrorWrapper},
        };
        ...
        pub(crate) async fn post<T: UdsEcu + Clone>(
            ...
            handler_write(
                ...
                &entry.communication_activities,
                &*communication_access,
                path,
                body,
        ...
        pub(crate) async fn handler_read(
            executions: &RwLock<IndexMap<Uuid, sovd_comparams::Execution>>,
            include_schema: bool,
        ) -> Response {
        ...
        async fn handler_write(
            executions: &RwLock<IndexMap<Uuid, sovd_comparams::Execution>>,
            communication_activities: &Mutex<HashMap<Uuid, CommunicationGuard>>,
        ...
        pub(crate) mod id {
            ...
            pub(crate) async fn delete<T: UdsEcu + Clone>(
                ...
                let comparam_executions = &entry.comparam_executions;
                let communication_activities = &entry.communication_activities;
...
pub(crate) mod service {
    ...
    pub(crate) mod executions {
        ...
        use crate::{
            openapi,
            sovd::{
                self, EcuContext, EcuRegistryEntry, ServiceExecution, WebserverEcuState,
