...
#[allow(unused_variables)] // Context is unused when dlt-tracing feature is disabled
#[allow(clippy::needless_pass_by_value)] // Context needs to be owned, when dlt-tracing is enabled
pub fn create_axum_trace_layer<S>(route: axum::Router<S>, context: String) -> axum::Router<S>
where
